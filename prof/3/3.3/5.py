...
Примечание 2. Дата-время в кортежах представлены в виде строк в формате DD.MM.YYYY HH:MM:SS.
"""
...
for name, datetime_ in data.items():
    data[name] = datetime.strptime(datetime_[1], DATETIME_FORMAT) - datetime.strptime(datetime_[0], DATETIME_FORMAT)
